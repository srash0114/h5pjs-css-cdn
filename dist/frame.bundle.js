    ...
    var e = {
          ...
          n.r(t),
            ...
            (i = function (e, t) {
              ...
              function Oe(e, t, n, r) {
                ...
                if (
                  m ||
                  (1 < f && "string" == typeof v && !h.checkClone && ke.test(v))
                )
                      ...
                      (l = s[d]),
                        ge.test(l.type || "") &&
                          ...
                          (l.src && "module" !== (l.type || "").toLowerCase()
                            ...
                            : b(l.textContent.replace(Ae, ""), l, u));
                }
                return e;
              }
              function Fe(e, t, n) {
        ...
        195: () => {
          ...
          (e.isFramed = window.self !== window.parent),
            ...
            (e.Dialog = function (t, n, r, i) {
              ...
              (o.open = function (t) {
                t && a.css("height", "100%"),
                  setTimeout(function () {
                    a.addClass("h5p-open"),
                      e.jQuery(o).trigger("dialog-opened", [a]),
                      a.focus();
                  }, 1);
              }),
                (o.close = function () {
                  a.removeClass("h5p-open"),
                    setTimeout(function () {
                      a.remove(),
                        e.jQuery(o).trigger("dialog-closed", [a]),
                        i.attr("tabindex", "-1"),
                        i.focus();
                    }, 200);
                });
                ...
                if (n.metadata) {
                  ...
                  if (void 0 !== o) {
                    if (
                      ...
                      o.setThumbnail(new e.Thumbnail(e.getPath(t, i), r, a));
                    }
                    t.addMedia(o);
                  }
                }
            ...
            (e.Thumbnail = function (t, n, r) {
              var i;
              void 0 !== n && (i = Math.round((n / r) * 100)),
                (this.toString = function () {
                  return (
                    '<img src="' +
                    t +
