        ...
        357: function (e, t) {
          ...
          !(function (t, n) {
            ...
            var E = (function (e) {
              ...
              try {
                N.apply((A = L.call(w.childNodes)), w.childNodes),
                ...
                (c = se.select =
                  function (e, t, n, i) {
                    ...
                    if (((n = n || []), 1 === p.length)) {
                      ...
                      for (
                        o = Q.needsContext.test(e) ? 0 : c.length;
                ...
                function (e, t) {
                  S.fn[e] = function (n, r) {
                    ...
                    return (
                      ...
                      1 < this.length &&
                        (F[e] || S.uniqueSort(i), O.test(e) && i.reverse()),
                      this.pushStack(i)
                    );
                  };
                }
                  ...
                  if ("object" === C(o)) S.merge(f, o.nodeType ? [o] : o);
                    ...
                    for (
                      a = a || d.appendChild(t.createElement("div")),
                        ...
                        c = ye[s] || ye._default,
                        a.innerHTML = c[1] + S.htmlPrefilter(o) + c[2],
                        u = c[0];
                      u--;
            ...
            (S.event = {
              ...
              dispatch: function (e) {
                ...
                if (
                  ...
                  for (
                    a = S.event.handlers.call(this, c, l), t = 0;
            ...
            function Re(e, t, n, r) {
              ...
              if (
                g ||
                (1 < f && "string" == typeof h && !v.checkClone && He.test(h))
              )
              ...
              if (
                ...
                for (s = (a = S.map(be(i, "script"), Oe)).length; d < f; d++)
                  (l = i),
                    d !== p &&
                      ((l = S.clone(l, !0, !0)),
                ...
                if (s)
                  for (
                    u = a[a.length - 1].ownerDocument, S.map(a, Fe), d = 0;
                    d < s;
                    d++
                  )
                    (l = a[d]),
            ...
            function tt(e, t, n, r, i, o) {
              ...
              for (; a < 4; a += 2)
                "margin" === n && (c += S.css(e, n + oe[a], !0, i)),
                  r
                    ? ("content" === n &&
                        (c -= S.css(e, "padding" + oe[a], !0, i)),
                      "margin" !== n &&
                        (c -= S.css(e, "border" + oe[a] + "Width", !0, i)))
                    : ((c += S.css(e, "padding" + oe[a], !0, i)),
                      "padding" !== n
                        ? (c += S.css(e, "border" + oe[a] + "Width", !0, i))
                ...
                S.cssHooks[t] = {
                  ...
                  set: function (e, n, r) {
                    var i,
                      ...
                      s =
                        (a || r) &&
                        "border-box" === S.css(e, "boxSizing", !1, o),
                      c = r ? tt(e, t, r, s, o) : 0;
                    return (
                      s &&
                        a &&
            ...
            function ht(e, t, n) {
              ...
              return (
                ...
                S.fx.timer(
                  S.extend(c, { elem: e, anim: l, queue: l.opts.queue })
                ),
                l
              );
            }
              ...
              S.extend({
                ...
                ajax: function (e, t) {
                  ...
                  p.ifModified &&
                    ...
                    S.etag[i] &&
                      P.setRequestHeader("If-None-Match", S.etag[i])),
                  ...
                  if (p.beforeSend && (!1 === p.beforeSend.call(h, P, p) || l))
                    return P.abort();
                  if (
                    ((C = "abort"),
                    m.add(p.complete),
                  ...
                  function T(e, t, a, c) {
                    ...
                    l ||
                      ...
                      (P.statusText = (t || C) + ""),
                      d
                        ? v.resolveWith(h, [f, C, P])
                        : v.rejectWith(h, [P, C, b]),
                      P.statusCode(y),
                      (y = void 0),
                      u &&
            ...
            S.ajaxSetup({
                  ...
                  return (
                    ...
                    n.always(function () {
                      void 0 === o ? S(r).removeProp(i) : (r[i] = o),
                        e[i] &&
                          ((e.jsonpCallback = t.jsonpCallback), Jt.push(i)),
                        a && m(o) && o(a[0]),
                        (a = o = void 0);
                    }),
                    "script"
              ...
              S.each(["top", "left"], function (e, t) {
                S.cssHooks[t] = _e(v.pixelPosition, function (e, n) {
                  if (n)
                    return (
                      (n = $e(e, t)), Be.test(n) ? S(e).position()[t] + "px" : n
                    );
                });
              }),
        ...
        (g.jQuery = h().noConflict(!0)),
          ...
          document.documentElement.requestFullScreen
            ...
            ? ((g.safariBrowser =
              ...
              (g.safariBrowser =
                null === g.safariBrowser ? 0 : parseInt(g.safariBrowser[1])),
              (0 === g.safariBrowser || g.safariBrowser > 6) &&
                (g.fullScreenBrowserPrefix = "webkit"))
            : document.documentElement.mozRequestFullScreen
            ? (g.fullScreenBrowserPrefix = "moz")
            : document.documentElement.msRequestFullscreen &&
              (g.fullScreenBrowserPrefix = "ms"),
          (g.opened = {}),
          (g.init = function (e) {
            void 0 === g.$body && (g.$body = g.jQuery(document.body)),
              ...
              void 0 === g.canHasFullScreen &&
                (g.canHasFullScreen = g.fullscreenSupported),
              g
                ...
                .each(function () {
                        ...
                        .on("dialog-opened", function (e, t) {
                          var r = function (e) {
                            ("click" !== e.type && 32 !== e.which) ||
                              (s.close(), g.deleteUserData(n, "state", 0));
                          };
                  ...
                  (g.offlineRequestQueue = new g.OfflineRequestQueue({
                    instance: o,
                  })),
                    1 == r.fullScreen &&
                      g.fullscreenSupported &&
                  ...
                  if (s.frame) {
                    ...
                    var u = new g.ActionBar(s),
                      d = u.getDOMElement();
                    u.on("reuse", function () {
                      g.openReuseDialog(d, r, i, o, n),
                        o.triggerXAPI("accessed-reuse");
                    }),
                      u.on("copyrights", function () {
                        new g.Dialog(
                          "copyrights",
                          g.t("copyrightInformation"),
                          l,
                          t
                        ).open(!0),
                          o.triggerXAPI("accessed-copyright");
                      }),
                      u.on("embed", function () {
                        g.openEmbedDialog(
                          d,
                  ...
                  if (
                    ...
                    !1 !== H5PIntegration.saveFreq &&
                      (o.getCurrentState instanceof Function ||
                        "function" == typeof o.getCurrentState))
                  ) {
                    var f,
                      p = function () {
                        var e = o.getCurrentState();
                        void 0 !== e &&
                          g.setUserData(n, "state", e, { deleteOnChange: !0 }),
                          H5PIntegration.saveFreq &&
                            (f = setTimeout(p, 1e3 * H5PIntegration.saveFreq));
                      };
                    H5PIntegration.saveFreq &&
                      (f = setTimeout(p, 1e3 * H5PIntegration.saveFreq)),
                      g.on(o, "xAPI", function (e) {
                        ...
                        ("completed" !== t && "progressed" !== t) ||
                          (clearTimeout(f), (f = setTimeout(p, 3e3)));
                      });
                  }
                  if (g.isFramed)
                          ...
                          (a = setTimeout(function () {
                            !(function () {
                              if (!window.parent.H5P.isFullscreen) {
                                ...
                                (h.parentElement.style.height =
                                  h.parentElement.clientHeight + "px"),
                                  h.getBoundingClientRect(),
                                  (h.style.height = "1px"),
                                  (h.style.height =
                                    h.contentDocument.body.scrollHeight + "px"),
                      ...
                      g.communicator.on("ready", function () {
                        ...
                        g.on(o, "resize", function () {
                          g.isFullscreen ||
                            ...
                            (a = setTimeout(function () {
                              v
                                ? g.communicator.send("prepareResize", {
                                    scrollHeight: document.body.scrollHeight,
                  ...
                  (g.isFramed && !1 !== g.externalEmbed) ||
                    ...
                    g.externalDispatcher &&
                      g.externalDispatcher.trigger("initialized");
                }),
              g
              ...
              var u = function (e) {
                ...
                f = function (e) {
                  (g.isFullscreen = !1),
                    ...
                    g.trigger(t, "resize"),
                    g.trigger(t, "focus"),
                    (g.exitFullScreen = void 0),
                    void 0 !== n && n(),
                    g.trigger(t, "exitFullScreen");
                };
              if (
                ((g.isFullscreen = !0),
                void 0 === g.fullScreenBrowserPrefix || !0 === i)
              ) {
                ...
                var p,
                  ...
                  y = (g.exitFullScreen = function () {
                    h ? (v.content = h) : w.removeChild(v),
                      m.remove(),
                      s.unbind("keyup", p),
                      f("h5p-semi-fullscreen");
                  });
                (p = function (e) {
                  27 === e.keyCode && y();
                }),
                ...
                var C,
                  P =
                    "ms" === g.fullScreenBrowserPrefix
                      ? "MSFullscreenChange"
                      : g.fullScreenBrowserPrefix + "fullscreenchange";
                if (
                  (document.addEventListener(P, function () {
                    if (void 0 === C) return (C = !1), void d();
                    f("h5p-fullscreen"),
                      document.removeEventListener(P, arguments.callee, !1);
                  }),
                  "" === g.fullScreenBrowserPrefix)
                )
                  ...
                  var S =
                      "ms" === g.fullScreenBrowserPrefix
                        ? "msRequestFullscreen"
                        : g.fullScreenBrowserPrefix + "RequestFullScreen",
                    T =
                      "webkit" === g.fullScreenBrowserPrefix &&
                      0 === g.safariBrowser
                ...
                g.exitFullScreen = function () {
                  "" === g.fullScreenBrowserPrefix
                    ...
                    : "moz" === g.fullScreenBrowserPrefix
                    ? document.mozCancelFullScreen()
                    : document[g.fullScreenBrowserPrefix + "ExitFullscreen"]();
                };
              }
            }
          }),
          ...
          (g.newRunnable = function (e, t, n, r, i) {
            ...
            if (
              ...
              return (
                g.error("Invalid library params for: " + e.library),
                g.error(e.params)
              );
            try {
            ...
            void 0 === i && (i = {}),
              ...
              e.userDatas &&
                e.userDatas.state &&
                H5PIntegration.saveFreq &&
                (i.previousState = e.userDatas.state),
              e.metadata && (i.metadata = e.metadata);
            var u,
              d = i.standalone || !1;
            return (
              (c.prototype = g.jQuery.extend(
                {},
                g.ContentType(d).prototype,
                c.prototype
              )),
              void 0 ===
                (u =
                  g.jQuery.inArray(e.library, [
              ...
              void 0 !== n &&
                (n.toggleClass("h5p-standalone", d),
                u.attach(n),
                g.trigger(
                  u,
                  "domChanged",
                  { $target: n, library: s, key: "newLibrary" },
                  { bubbles: !0, external: !0 }
                ),
                (void 0 !== r && r) || g.trigger(u, "resize")),
              u
            );
          }),
          (g.error = function (e) {
          ...
          (g.Dialog = function (e, t, n, r) {
            ...
            (i.open = function (e) {
              e && o.css("height", "100%"),
                setTimeout(function () {
                  o.addClass("h5p-open"),
                    g.jQuery(i).trigger("dialog-opened", [o]),
                    o.focus();
                }, 1);
            }),
              (i.close = function () {
                o.removeClass("h5p-open"),
                  setTimeout(function () {
                    o.remove(),
                      g.jQuery(i).trigger("dialog-closed", [o]),
                      r.attr("tabindex", "-1"),
                      r.focus();
                  }, 200);
              });
          ...
          (g.getCopyrights = function (e, t, n, r) {
            ...
            void 0 === i &&
              ((i = new g.ContentCopyrights()), g.findCopyrights(i, t, n));
            var o = g.buildMetadataCopyrights(r, e.libraryInfo.machineName);
            return (
              void 0 !== o && i.addMediaInFront(o),
              void 0 !== i && (i = i.toString()),
              i
            );
          }),
                ...
                if ("overrideSettings" !== o) {
                  ...
                  if (
                    (a && a.library && "string" == typeof a.library
                      ...
                      : a &&
                        a.library &&
                        "object" == typeof a.library &&
                        (i =
                          a.library.library &&
                          "string" == typeof a.library.library
                            ? a.library.library.split(" ")[0]
                            : i),
                    a instanceof Array)
                  )
                ...
                var n = t.find(".h5p-inner").find(".h5p-scroll-content"),
                  ...
                  u = function () {
                    t.find(".h5p-embed-code-container:first").val(
                      o
                        .replace(":w", l(s, r.width))
                        .replace(":h", l(c, r.height))
                    );
                  };
                s.change(u),
                  c.change(u),
                ...
                var d = function () {
                  ...
                  n.is(":visible")
                    ? (e
                        ...
                        .text(g.t("showAdvanced"))
                        .attr("aria-expanded", "true"),
                      n.hide())
                    : (e
                        .addClass("h5p-open")
                        .text(g.t("hideAdvanced"))
          ...
          (g.MediaCopyright = function (e, t, n, r) {
            var i,
              ...
              s = function (e, t) {
                var n,
                  ...
                  o = "";
                ("PD" === e && t) ||
                  (o += i.hasOwnProperty("label") ? i.label : i),
                  i.versions &&
                    (!i.versions.default ||
                      (t && i.versions[t]) ||
                      (t = i.versions.default),
                    t && i.versions[t] && (n = i.versions[t])),
                  n &&
                    (o && (o += " "),
                    (o += n.hasOwnProperty("label") ? n.label : n)),
                  i.hasOwnProperty("link")
                    ? (r = i.link.replace(
                        ":version",
                        i.linkVersions ? i.linkVersions[t] : t
                      ))
                    : n && i.hasOwnProperty("link") && (r = n.link),
                  r &&
                    (o = '<a href="' + r + '" target="_blank">' + o + "</a>");
                var a = "";
                return (
                  "PD" !== e && "C" !== e && (a += e),
                  t &&
            ...
            if (void 0 !== e) {
              ...
              for (var l = 0; l < n.length; l++) {
                ...
                if (void 0 !== e[u] && "" !== e[u]) {
                  var d = e[u];
                  "license" === u && (d = s(e.license, e.version)),
                    "source" === u &&
                      (d = d
                        ? '<a href="' + d + '" target="_blank">' + d + "</a>"
                        : void 0),
                    o.add(new g.Field(a(u), d));
                }
              }
            }
            (this.setThumbnail = function (e) {
              ...
              (this.undisclosed = function () {
                if (1 === o.size()) {
                  var e = o.get(0);
                  if (e.getLabel() === a("license") && e.getValue() === s("U"))
                    return !0;
                }
                return !1;
              }),
          ...
          (g.jsLoaded = function (e) {
            return (
              ...
              -1 !== g.jQuery.inArray(e, H5PIntegration.loadedJs)
            );
          }),
          (g.cssLoaded = function (e) {
            return (
              (H5PIntegration.loadedCss = H5PIntegration.loadedCss || []),
              -1 !== g.jQuery.inArray(e, H5PIntegration.loadedCss)
            );
          }),
          ...
          (g.setFinished = function (e, t, n, r) {
            if (
              ...
              g.jQuery
                .post(H5PIntegration.ajax.setFinished, o)
                .fail(function () {
          ...
          (function (e) {
            ...
            (g.getUserData = function (e, n, r, i) {
              ...
              (g.setUserData = function (e, n, r, i) {
                ...
                void 0 === a && (a = H5PIntegration.contents["cid-" + e] = {}),
                  a.contentUserData || (a.contentUserData = {});
              ...
              (g.clipboardify = function (e) {
                e instanceof g.ClipboardItem || (e = new g.ClipboardItem(e)),
                  g.setClipboard(e);
              }),
              ...
              (g.setClipboard = function (e) {
                localStorage.setItem("h5pClipboard", JSON.stringify(e)),
                  g.externalDispatcher.trigger("datainclipboard", {
                    reset: !1,
                  });
              }),
            ...
            e(document).ready(function () {
              ...
              if (
                ((g.copyrightLicenses = {
                  U: g.t("licenseU"),
                  "CC BY": {
                    label: g.t("licenseCCBY"),
                    link: "http://creativecommons.org/licenses/by/:version",
                    versions: e,
                  },
                  "CC BY-SA": {
                    label: g.t("licenseCCBYSA"),
                    link: "http://creativecommons.org/licenses/by-sa/:version",
                    versions: e,
                  },
                  "CC BY-ND": {
                    label: g.t("licenseCCBYND"),
                    link: "http://creativecommons.org/licenses/by-nd/:version",
                    versions: e,
                  },
                  "CC BY-NC": {
                    label: g.t("licenseCCBYNC"),
                    link: "http://creativecommons.org/licenses/by-nc/:version",
                    versions: e,
                  },
                  "CC BY-NC-SA": {
                    label: g.t("licenseCCBYNCSA"),
                    link: "http://creativecommons.org/licenses/by-nc-sa/:version",
                    versions: e,
                  },
                  "CC BY-NC-ND": {
                    label: g.t("licenseCCBYNCND"),
                    link: "http://creativecommons.org/licenses/by-nc-nd/:version",
                    versions: e,
                  },
                  "CC0 1.0": {
                    label: g.t("licenseCC010"),
                    ...
                    if (e - t > 250) {
                      ...
                      for (var n = 0; n < g.instances.length; n++) {
                        ...
                        if (
                          ...
                          void 0 !== i &&
                            g.setUserData(r.contentId, "state", i, {
                              deleteOnChange: !0,
                              async: !1,
                            });
                        }
        ...
        var y = (function () {
          function e(t, n) {
            !(function (e, t) {
              ...
              n.h5pJsonPath
                ? (this.h5pJsonPath = m(n.h5pJsonPath))
                : (this.h5pJsonPath = m("workspace")),
              n.librariesPath
                ? (this.librariesPath = m(n.librariesPath))
                : (this.librariesPath = this.h5pJsonPath),
              n.contentJsonPath
                ? (this.contentUrl = m(n.contentJsonPath))
                : (this.contentUrl = m(
                    "".concat(this.h5pJsonPath, "/content")
                  ));
            var r = {
              displayOptions: {
                frame: n.frame,
            ...
            (n = [
              {
                ...
                value: function (e) {
                  ...
                  t.classList.add("h5p-iframe-wrapper"),
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  (e.next = 2),
                                  this.getJSON(
                                    "".concat(this.h5pJsonPath, "/h5p.json")
                                  )
                                );
                              case 2:
                                return (
                                  ...
                                  (e.next = 5),
                                  this.getJSON(
                                    "".concat(this.contentUrl, "/content.json")
                                  )
                                );
                              case 5:
                                return (
                                  (i = e.sent),
                                  (e.next = 8),
                                  this.checkIfPathIncludesVersion()
                                );
                              case 8:
                                return (
                                  (H5PIntegration.pathIncludesVersion =
                                    this.pathIncludesVersion =
                                      e.sent),
                                  (e.next = 11),
                                  this.findMainLibrary()
                                );
                              case 11:
                                return (
                                  (this.mainLibrary = e.sent),
                                  (e.next = 14),
                              ...
                              case 14:
                                ...
                                (H5PIntegration.core = {
                                  styles: t.coreStyles,
                                  scripts: t.coreScripts,
                                }),
                                (H5PIntegration.contents[
                                  "cid-".concat(this.id)
                                ] = {
                                  library: ""
                                    .concat(this.mainLibrary.machineName, " ")
                                    .concat(this.mainLibrary.majorVersion, ".")
                                    .concat(this.mainLibrary.minorVersion),
                            ...
                            switch ((e.prev = e.next)) {
                              case 0:
                                return (
                                  ...
                                  this.getJSON(
                                    ""
                                      .concat(this.librariesPath, "/")
                                      .concat(n, "/library.json")
                                  )
                                );
                              case 5:
                                (r = !0), (e.next = 11);
                ...
                value: function () {
                  ...
                  return (
                    ...
                    this.getJSON(
                      ""
                        .concat(this.librariesPath, "/")
                        .concat(this.mainLibraryPath, "/library.json")
                    )
                  );
                },
              },
                              ...
                              case 2:
                                return (
                                  ...
                                  n.preloadedDependencies &&
                                    (i = n.preloadedDependencies.map(function (
                                      e
                                    ) {
                                  ...
                                  e.abrupt("return", {
                                    libraryPath: r,
                                    dependencies: i,
                                    preloadedCss: n.preloadedCss,
                                    preloadedJs: n.preloadedJs,
                                  })
                                );
                              case 7:
                              case "end":
                ...
                value: function (e, t) {
                  ...
                  e.forEach(function (e) {
                    r.add(e.libraryPath, e.dependencies),
                      e.preloadedCss &&
                        ((i[e.libraryPath] = i[e.libraryPath]
                          ? i[e.libraryPath]
                          : []),
                        e.preloadedCss.forEach(function (t) {
                          i[e.libraryPath].push(
                            ""
                              .concat(n.librariesPath, "/")
                              .concat(e.libraryPath, "/")
                              .concat(t.path)
                          );
                        })),
                      e.preloadedJs &&
                        ((o[e.libraryPath] = o[e.libraryPath]
                          ? o[e.libraryPath]
                          : []),
                        e.preloadedJs.forEach(function (t) {
                          o[e.libraryPath].push(
                            ""
                              .concat(n.librariesPath, "/")
                              .concat(e.libraryPath, "/")
                              .concat(t.path)
                  ...
                  return (
                    r
                      ...
                      .reverse()
                      .forEach(function (e) {
                        Array.prototype.push.apply(a, i[e]),
                          Array.prototype.push.apply(s, o[e]);
                      }),
